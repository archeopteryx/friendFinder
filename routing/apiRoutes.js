// Dependencies - get to the storage file
var friends = require("../app/friends.js");

// Export the function
module.exports = (app) => {

    // get entire list from friends.js (as exported from that page)
    app.get('/api/friends', (req, res) => {
        res.json(friends);
    });

    // posts new data into the array in friends.js
    app.post('/api/friends', (req, res) => {
        ...
        // loop through each to find a friend
        friends.forEach(function(friend) {
            ...
            // loops through each of scores arrays for each friend from both the stored data and the new user, and then substracts, absolutes, and then pushes the new value to the matchedScoresArray
            for (var i = 0; i < 9; i++) {
